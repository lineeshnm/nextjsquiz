  ...
  return (
    <div className='flex-grow px-12'>
      <div className="text-center text-4xl font-semibold text-white mb-8 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
        Middleware Certificate Dashboard - Not to Renew
      </div>
      <div >
...
export const getStaticProps = async (context) => {
  ...
  return {
    props: { certs: data.data.filter(row => row.hasOwnProperty('renew') && !row.renew) }, // will be passed to the page component as props
    revalidate: 10
  }
}