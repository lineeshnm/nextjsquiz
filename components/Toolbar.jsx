...
const Toolbar = ({drawerToggleClickHandler, sideDrawerOpen}) => {
    ...
    return (
        <div className='fixed left-2 right-2 top-2 lg:left-12 lg:right-12 md:left-6 md:right-6 sm:left-2 sm:right-2 lg:top-6 md:top-4 sm:top-2 glass-item'>
            <div className="flex justify-between w-full p-2 lg:p-8 md:p-6 sm:p-2">
